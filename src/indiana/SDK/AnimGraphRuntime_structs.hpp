...
public:
	...
	bool                                          bForceResetPlayTime;                               // 0x0058(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59[0x8F];                                      // 0x0059(0x008F)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FAnimNode_BlendSpacePlayer) == 0x0000F0, "Wrong size on FAnimNode_BlendSpacePlayer");
...
static_assert(offsetof(FAnimNode_BlendSpacePlayer, bForceResetPlayTime) == 0x000058, "Member 'FAnimNode_BlendSpacePlayer::bForceResetPlayTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, PreviousBlendSpace) == 0x0000E8, "Member 'FAnimNode_BlendSpacePlayer::PreviousBlendSpace' has a wrong offset!");
...
public:
	...
	float                                         PlayRate;                                          // 0x0020(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x54];                                      // 0x0024(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FAnimNode_RandomPlayer) == 0x000080, "Wrong size on FAnimNode_RandomPlayer");
static_assert(offsetof(FAnimNode_RandomPlayer, Entries) == 0x000010, "Member 'FAnimNode_RandomPlayer::Entries' has a wrong offset!");
static_assert(offsetof(FAnimNode_RandomPlayer, PlayRate) == 0x000020, "Member 'FAnimNode_RandomPlayer::PlayRate' has a wrong offset!");
static_assert(offsetof(FAnimNode_RandomPlayer, bShuffleMode) == 0x000078, "Member 'FAnimNode_RandomPlayer::bShuffleMode' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendSpaceEvaluator) == 0x0000F8, "Wrong size on FAnimNode_BlendSpaceEvaluator");
static_assert(offsetof(FAnimNode_BlendSpaceEvaluator, NormalizedTime) == 0x0000F0, "Member 'FAnimNode_BlendSpaceEvaluator::NormalizedTime' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RotationOffsetBlendSpace) == 0x000198, "Wrong size on FAnimNode_RotationOffsetBlendSpace");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, BasePose) == 0x0000F0, "Member 'FAnimNode_RotationOffsetBlendSpace::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, LODThreshold) == 0x000100, "Member 'FAnimNode_RotationOffsetBlendSpace::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, Alpha) == 0x000104, "Member 'FAnimNode_RotationOffsetBlendSpace::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBias) == 0x000108, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaBoolBlend) == 0x000110, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaCurveName) == 0x000158, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x000160, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x000194, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bAlphaBoolEnabled) == 0x000195, "Member 'FAnimNode_RotationOffsetBlendSpace::bAlphaBoolEnabled' has a wrong offset!");
