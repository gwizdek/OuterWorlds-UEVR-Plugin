...
{
public:
	class UGeometryCacheComponent*                GeometryCacheComponent;                            // 0x02B8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AGeometryCacheActor) == 0x0002C0, "Wrong size on AGeometryCacheActor");
static_assert(offsetof(AGeometryCacheActor, GeometryCacheComponent) == 0x0002B8, "Member 'AGeometryCacheActor::GeometryCacheComponent' has a wrong offset!");
...
public:
	...
	bool                                          bExtrapolateFrames;                                // 0x052A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	float                                         MotionVectorScale;                                 // 0x0534(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumTracks;                                         // 0x0538(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         ElapsedTime;                                       // 0x053C(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_540[0x34];                                     // 0x0540(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UGeometryCacheComponent, bExtrapolateFrames) == 0x00052A, "Member 'UGeometryCacheComponent::bExtrapolateFrames' has a wrong offset!");
...
static_assert(offsetof(UGeometryCacheComponent, MotionVectorScale) == 0x000534, "Member 'UGeometryCacheComponent::MotionVectorScale' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, NumTracks) == 0x000538, "Member 'UGeometryCacheComponent::NumTracks' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, ElapsedTime) == 0x00053C, "Member 'UGeometryCacheComponent::ElapsedTime' has a wrong offset!");
