...
public:
	...
	struct FRigVMExecuteContext                   Context;                                           // 0x01C8(0x0058)(Transient, NativeAccessSpecifierPrivate)
	...
	TMap<class FName, int32>                      ParametersNameMap;                                 // 0x0260(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_2B0[0x48];                                     // 0x02B0(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
	class URigVM*                                 DeferredVMToCopy;                                  // 0x02F8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(URigVM) == 0x000300, "Wrong size on URigVM");
...
static_assert(offsetof(URigVM, ParametersNameMap) == 0x000260, "Member 'URigVM::ParametersNameMap' has a wrong offset!");
static_assert(offsetof(URigVM, DeferredVMToCopy) == 0x0002F8, "Member 'URigVM::DeferredVMToCopy' has a wrong offset!");
