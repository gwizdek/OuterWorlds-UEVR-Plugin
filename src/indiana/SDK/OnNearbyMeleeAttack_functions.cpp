...
#include "OnNearbyMeleeAttack_classes.hpp"
#include "OnNearbyMeleeAttack_parameters.hpp"
...
TArray<class UDecisionTreeRequestData*> UOnNearbyMeleeAttack_C::RunDecisionTree(class AIndianaAiCharacter* Owner, class FName EventType, class UAIEventInfo* EventInfo, EDecisionTreeRequestPriority* OutPriority)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("OnNearbyMeleeAttack_C", "RunDecisionTree");

	Params::OnNearbyMeleeAttack_C_RunDecisionTree Parms{};
