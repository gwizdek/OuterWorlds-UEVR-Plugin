...
{
public:
	struct FTextBlockStyle                        TextStyle;                                         // 0x0008(0x0278)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRichTextStyleRow) == 0x000008, "Wrong alignment on FRichTextStyleRow");
static_assert(sizeof(FRichTextStyleRow) == 0x000280, "Wrong size on FRichTextStyleRow");
...
struct alignas(0x08) FSlateMetaData final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSlateMetaData) == 0x000008, "Wrong alignment on FSlateMetaData");
static_assert(sizeof(FSlateMetaData) == 0x000010, "Wrong size on FSlateMetaData");
