...
public:
	...
	class FName                                   AttachSocket;                                      // 0x004C(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   LookAtSocket;                                      // 0x0054(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Offset;                                            // 0x005C(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FCameraLookatTrackingSettings, AttachSocket) == 0x00004C, "Member 'FCameraLookatTrackingSettings::AttachSocket' has a wrong offset!");
static_assert(offsetof(FCameraLookatTrackingSettings, LookAtSocket) == 0x000054, "Member 'FCameraLookatTrackingSettings::LookAtSocket' has a wrong offset!");
static_assert(offsetof(FCameraLookatTrackingSettings, Offset) == 0x00005C, "Member 'FCameraLookatTrackingSettings::Offset' has a wrong offset!");
