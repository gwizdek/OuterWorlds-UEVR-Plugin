...
{
public:
	struct FSoftClassPath                         BurnInClass;                                       // 0x0050(0x0018)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UTextureRenderTarget2D*                 RenderTarget;                                      // 0x0098(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMoviePipelineBurnInWidget*             BurnInWidgetInstance;                              // 0x00A0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipelineBurnInSetting) == 0x0000A8, "Wrong size on UMoviePipelineBurnInSetting");
...
static_assert(offsetof(UMoviePipelineBurnInSetting, BurnInWidgetInstance) == 0x0000A0, "Member 'UMoviePipelineBurnInSetting::BurnInWidgetInstance' has a wrong offset!");
