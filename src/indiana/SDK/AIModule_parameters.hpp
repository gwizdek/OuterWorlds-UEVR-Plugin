...
public:
	...
	bool                                          bDeferredSpawn;                                    // 0x0040(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AIBlueprintHelperLibrary_SpawnAIFromClass) == 0x000050, "Wrong size on AIBlueprintHelperLibrary_SpawnAIFromClass");
...
static_assert(offsetof(AIBlueprintHelperLibrary_SpawnAIFromClass, bDeferredSpawn) == 0x000040, "Member 'AIBlueprintHelperLibrary_SpawnAIFromClass::bDeferredSpawn' has a wrong offset!");
static_assert(offsetof(AIBlueprintHelperLibrary_SpawnAIFromClass, ReturnValue) == 0x000048, "Member 'AIBlueprintHelperLibrary_SpawnAIFromClass::ReturnValue' has a wrong offset!");
