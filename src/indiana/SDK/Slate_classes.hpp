...
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0038(0x07F8)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000830, "Wrong size on UEditableTextBoxWidgetStyle");
...
{
public:
	struct FEditableTextStyle                     EditableTextStyle;                                 // 0x0038(0x0220)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextWidgetStyle) == 0x000258, "Wrong size on UEditableTextWidgetStyle");
...
{
public:
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0038(0x0278)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTextBlockWidgetStyle) == 0x0002B0, "Wrong size on UTextBlockWidgetStyle");
