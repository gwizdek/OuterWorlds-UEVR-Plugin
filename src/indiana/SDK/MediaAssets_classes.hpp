...
static_assert(sizeof(UMediaComponent) == 0x0000F0, "Wrong size on UMediaComponent");
static_assert(offsetof(UMediaComponent, MediaTexture) == 0x0000E0, "Member 'UMediaComponent::MediaTexture' has a wrong offset!");
static_assert(offsetof(UMediaComponent, MediaPlayer) == 0x0000E8, "Member 'UMediaComponent::MediaPlayer' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_758[0x138];                                    // 0x0758(0x0138)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMediaSoundComponent) == 0x000890, "Wrong size on UMediaSoundComponent");
static_assert(offsetof(UMediaSoundComponent, Channels) == 0x000730, "Member 'UMediaSoundComponent::Channels' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, DynamicRateAdjustment) == 0x000734, "Member 'UMediaSoundComponent::DynamicRateAdjustment' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentFactor) == 0x000738, "Member 'UMediaSoundComponent::RateAdjustmentFactor' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentRange) == 0x00073C, "Member 'UMediaSoundComponent::RateAdjustmentRange' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, MediaPlayer) == 0x000750, "Member 'UMediaSoundComponent::MediaPlayer' has a wrong offset!");
