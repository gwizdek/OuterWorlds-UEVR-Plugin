...
#include "Death_classes.hpp"
#include "Death_parameters.hpp"
...
TArray<class UDecisionTreeRequestData*> UDeath_C::RunDecisionTree(class AIndianaAiCharacter* Owner, class FName EventType, class UAIEventInfo* EventInfo, EDecisionTreeRequestPriority* OutPriority)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Death_C", "RunDecisionTree");

	Params::Death_C_RunDecisionTree Parms{};
