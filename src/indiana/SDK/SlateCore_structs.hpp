...
public:
	...
	float                                         SliderIndentation;                                 // 0x033C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseSliderIndentation;                             // 0x0340(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FSliderStyle) == 0x000348, "Wrong size on FSliderStyle");
...
static_assert(offsetof(FSliderStyle, SliderIndentation) == 0x00033C, "Member 'FSliderStyle::SliderIndentation' has a wrong offset!");
static_assert(offsetof(FSliderStyle, bUseSliderIndentation) == 0x000340, "Member 'FSliderStyle::bUseSliderIndentation' has a wrong offset!");
...
{
public:
	struct FSliderStyle                           SliderStyle;                                       // 0x0008(0x0348)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            HighVolumeImage;                                   // 0x0350(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            MidVolumeImage;                                    // 0x03D8(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            LowVolumeImage;                                    // 0x0460(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            NoVolumeImage;                                     // 0x04E8(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            MutedImage;                                        // 0x0570(0x0088)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVolumeControlStyle) == 0x000008, "Wrong alignment on FVolumeControlStyle");
static_assert(sizeof(FVolumeControlStyle) == 0x0005F8, "Wrong size on FVolumeControlStyle");
...
static_assert(offsetof(FVolumeControlStyle, HighVolumeImage) == 0x000350, "Member 'FVolumeControlStyle::HighVolumeImage' has a wrong offset!");
static_assert(offsetof(FVolumeControlStyle, MidVolumeImage) == 0x0003D8, "Member 'FVolumeControlStyle::MidVolumeImage' has a wrong offset!");
static_assert(offsetof(FVolumeControlStyle, LowVolumeImage) == 0x000460, "Member 'FVolumeControlStyle::LowVolumeImage' has a wrong offset!");
static_assert(offsetof(FVolumeControlStyle, NoVolumeImage) == 0x0004E8, "Member 'FVolumeControlStyle::NoVolumeImage' has a wrong offset!");
static_assert(offsetof(FVolumeControlStyle, MutedImage) == 0x000570, "Member 'FVolumeControlStyle::MutedImage' has a wrong offset!");
...
public:
	...
	bool                                          bAllowManualColorChanging;                         // 0x0088(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_89[0x3];                                       // 0x0089(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              ShadowOffset;                                      // 0x008C(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FTextBlockStyle) == 0x000278, "Wrong size on FTextBlockStyle");
...
static_assert(offsetof(FTextBlockStyle, bAllowManualColorChanging) == 0x000088, "Member 'FTextBlockStyle::bAllowManualColorChanging' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, ShadowOffset) == 0x00008C, "Member 'FTextBlockStyle::ShadowOffset' has a wrong offset!");
...
static_assert(offsetof(FTextBlockStyle, UnderlineBrush) == 0x0001F0, "Member 'FTextBlockStyle::UnderlineBrush' has a wrong offset!");

// ScriptStruct SlateCore.WindowStyle
// 0x1060 (0x1068 - 0x0008)
...
public:
	...
	struct FTextBlockStyle                        TitleTextStyle;                                    // 0x09E8(0x0278)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ActiveTitleBrush;                                  // 0x0C60(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            InactiveTitleBrush;                                // 0x0CE8(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            FlashTitleBrush;                                   // 0x0D70(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            BackgroundColor;                                   // 0x0DF8(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            OutlineBrush;                                      // 0x0E20(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            OutlineColor;                                      // 0x0EA8(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BorderBrush;                                       // 0x0ED0(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundBrush;                                   // 0x0F58(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ChildBackgroundBrush;                              // 0x0FE0(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWindowStyle) == 0x000008, "Wrong alignment on FWindowStyle");
static_assert(sizeof(FWindowStyle) == 0x001068, "Wrong size on FWindowStyle");
...
static_assert(offsetof(FWindowStyle, ActiveTitleBrush) == 0x000C60, "Member 'FWindowStyle::ActiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x000CE8, "Member 'FWindowStyle::InactiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x000D70, "Member 'FWindowStyle::FlashTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x000DF8, "Member 'FWindowStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x000E20, "Member 'FWindowStyle::OutlineBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x000EA8, "Member 'FWindowStyle::OutlineColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x000ED0, "Member 'FWindowStyle::BorderBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x000F58, "Member 'FWindowStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, ChildBackgroundBrush) == 0x000FE0, "Member 'FWindowStyle::ChildBackgroundBrush' has a wrong offset!");
...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x0800(0x0278)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FInlineEditableTextBlockStyle) == 0x000008, "Wrong alignment on FInlineEditableTextBlockStyle");
static_assert(sizeof(FInlineEditableTextBlockStyle) == 0x000A78, "Wrong size on FInlineEditableTextBlockStyle");
...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x0280(0x0278)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FMargin                                Padding;                                           // 0x04F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FHyperlinkStyle) == 0x000008, "Wrong alignment on FHyperlinkStyle");
static_assert(sizeof(FHyperlinkStyle) == 0x000508, "Wrong size on FHyperlinkStyle");
...
static_assert(offsetof(FHyperlinkStyle, Padding) == 0x0004F8, "Member 'FHyperlinkStyle::Padding' has a wrong offset!");
