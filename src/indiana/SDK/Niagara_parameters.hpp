...
public:
	...
	bool                                          bFlushDeletionList;                                // 0x0008(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(NiagaraComponent_AdvanceSimulation) == 0x00000C, "Wrong size on NiagaraComponent_AdvanceSimulation");
...
static_assert(offsetof(NiagaraComponent_AdvanceSimulation, bFlushDeletionList) == 0x000008, "Member 'NiagaraComponent_AdvanceSimulation::bFlushDeletionList' has a wrong offset!");
...
// Function Niagara.NiagaraComponent.GetAutoDestroy
// 0x0001 (0x0001 - 0x0000)
struct NiagaraComponent_GetAutoDestroy final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(NiagaraComponent_GetAutoDestroy) == 0x000001, "Wrong alignment on NiagaraComponent_GetAutoDestroy");
static_assert(sizeof(NiagaraComponent_GetAutoDestroy) == 0x000001, "Wrong size on NiagaraComponent_GetAutoDestroy");
static_assert(offsetof(NiagaraComponent_GetAutoDestroy, ReturnValue) == 0x000000, "Member 'NiagaraComponent_GetAutoDestroy::ReturnValue' has a wrong offset!");
