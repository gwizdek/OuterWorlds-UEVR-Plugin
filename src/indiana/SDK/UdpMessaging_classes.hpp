...
static_assert(offsetof(UUdpMessagingSettings, bStopServiceWhenAppDeactivates) == 0x00003C, "Member 'UUdpMessagingSettings::bStopServiceWhenAppDeactivates' has a wrong offset!");
