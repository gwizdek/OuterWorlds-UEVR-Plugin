...
{
public:
	struct FMovieSceneGeometryCollectionParams    Params_0;                                          // 0x00F0(0x0030)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneGeometryCollectionSection) == 0x000120, "Wrong size on UMovieSceneGeometryCollectionSection");
