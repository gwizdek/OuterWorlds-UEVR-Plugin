...
public:
	...
	TArray<struct FGameModeName>                  GameModeMapPrefixes;                               // 0x00D8(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)
	TArray<struct FGameModeName>                  GameModeClassAliases;                              // 0x00E8(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)
...
class UVersionSettings final : public UObject
{
public:
	class FString                                 Version;                                           // 0x0030(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Configuration;                                     // 0x0040(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"VersionSettings">();
	}
	static class UVersionSettings* GetDefaultObj()
	{
		return GetDefaultObjImpl<UVersionSettings>();
	}
};
static_assert(alignof(UVersionSettings) == 0x000008, "Wrong alignment on UVersionSettings");
static_assert(sizeof(UVersionSettings) == 0x000050, "Wrong size on UVersionSettings");
static_assert(offsetof(UVersionSettings, Version) == 0x000030, "Member 'UVersionSettings::Version' has a wrong offset!");
static_assert(offsetof(UVersionSettings, Configuration) == 0x000040, "Member 'UVersionSettings::Configuration' has a wrong offset!");
