...
// ScriptStruct Landscape.HeightmapDataTmp
// 0x0008 (0x0008 - 0x0000)
struct FHeightmapDataTmp final
{
public:
...
static_assert(alignof(FHeightmapDataTmp) == 0x000008, "Wrong alignment on FHeightmapDataTmp");
static_assert(sizeof(FHeightmapDataTmp) == 0x000008, "Wrong size on FHeightmapDataTmp");
static_assert(offsetof(FHeightmapDataTmp, Texture) == 0x000000, "Member 'FHeightmapDataTmp::Texture' has a wrong offset!");
...
{
public:
	struct FHeightmapDataTmp                      HeightmapData;                                     // 0x0000(0x0008)(NoDestructor, NativeAccessSpecifierPublic)
