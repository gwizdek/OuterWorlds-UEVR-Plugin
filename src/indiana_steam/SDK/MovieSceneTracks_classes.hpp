...
{
public:
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x00F0(0x00B0)(NativeAccessSpecifierPrivate)
	struct FIntegralCurve                         ActorGuidIndexCurve;                               // 0x01A0(0x0080)(Deprecated, NativeAccessSpecifierPrivate)
	TArray<class FString>                         ActorGuidStrings;                                  // 0x0220(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneActorReferenceSection) == 0x000230, "Wrong size on UMovieSceneActorReferenceSection");
...
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorGuidIndexCurve) == 0x0001A0, "Member 'UMovieSceneActorReferenceSection::ActorGuidIndexCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorGuidStrings) == 0x000220, "Member 'UMovieSceneActorReferenceSection::ActorGuidStrings' has a wrong offset!");
...
public:
	...
	struct FMovieSceneActorReferenceData          AttachActorData;                                   // 0x0250(0x00B0)(NativeAccessSpecifierPrivate)
	bool                                          bLooping;                                          // 0x0300(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bSuppressSubtitles;                                // 0x0301(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOverrideAttenuation;                              // 0x0302(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TDelegate<void(TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles;                                  // 0x0310(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void()>              OnAudioFinished;                                   // 0x0320(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(class USoundWave* PlayingSoundWave, float PlaybackPercent)> OnAudioPlaybackPercent;                            // 0x0330(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneAudioSection) == 0x000340, "Wrong size on UMovieSceneAudioSection");
...
static_assert(offsetof(UMovieSceneAudioSection, bLooping) == 0x000300, "Member 'UMovieSceneAudioSection::bLooping' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bSuppressSubtitles) == 0x000301, "Member 'UMovieSceneAudioSection::bSuppressSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bOverrideAttenuation) == 0x000302, "Member 'UMovieSceneAudioSection::bOverrideAttenuation' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AttenuationSettings) == 0x000308, "Member 'UMovieSceneAudioSection::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnQueueSubtitles) == 0x000310, "Member 'UMovieSceneAudioSection::OnQueueSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnAudioFinished) == 0x000320, "Member 'UMovieSceneAudioSection::OnAudioFinished' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnAudioPlaybackPercent) == 0x000330, "Member 'UMovieSceneAudioSection::OnAudioPlaybackPercent' has a wrong offset!");
...
{
public:
	class UEnum*                                  Enum;                                              // 0x00C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x00F0(0x00C0)(NativeAccessSpecifierPublic)
...
public:
	...
	class UClass*                                 PropertyClass;                                     // 0x00D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FMovieSceneObjectPathChannel           MaterialChannel;                                   // 0x00F0(0x00C0)(NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_C8[0x8];                                       // 0x00C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaterialIndex;                                     // 0x00D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneVectorTrack) == 0x0000D0, "Wrong size on UMovieSceneVectorTrack");
static_assert(offsetof(UMovieSceneVectorTrack, NumChannelsUsed) == 0x0000C8, "Member 'UMovieSceneVectorTrack::NumChannelsUsed' has a wrong offset!");
