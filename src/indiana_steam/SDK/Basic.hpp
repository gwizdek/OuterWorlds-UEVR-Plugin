...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0628A160;
	constexpr int32 AppendString      = 0x019FD2B0;
	constexpr int32 GNames            = 0x0624DD40;
	constexpr int32 GWorld            = 0x063D34D0;
	constexpr int32 ProcessEvent      = 0x01BFA720;
