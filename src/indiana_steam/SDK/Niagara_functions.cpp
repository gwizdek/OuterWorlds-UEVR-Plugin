...
// bool                                    bFlushDeletionList                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UNiagaraComponent::AdvanceSimulation(int32 TickCount, float TickDeltaSeconds, bool bFlushDeletionList)
{
	static class UFunction* Func = nullptr;
	...
	Parms.bFlushDeletionList = bFlushDeletionList;
...
bool UNiagaraComponent::GetAutoDestroy() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraComponent", "GetAutoDestroy");

	Params::NiagaraComponent_GetAutoDestroy Parms{};
