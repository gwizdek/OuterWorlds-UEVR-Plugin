...
{
public:
	class FString                                 ObjectUID;                                         // 0x0268(0x0010)(Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         UserIndex;                                         // 0x0278(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSet<EMagicLeapARPinType>                     SearchPinTypes;                                    // 0x0288(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class USphereComponent*                       SearchVolume;                                      // 0x02D8(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(bool bRestoredOrSynced)> OnPersistentEntityPinned;                          // 0x02E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnPersistentEntityPinLost;                         // 0x02F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(bool bDataRestored)> OnPinDataLoadAttemptCompleted;                     // 0x0300(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FGuid                                  PinnedCFUID;                                       // 0x0310(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USceneComponent*                        PinnedSceneComponent;                              // 0x0320(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMagicLeapARPinSaveGame*                PinData;                                           // 0x0328(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_330[0xF0];                                     // 0x0330(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMagicLeapARPinComponent) == 0x000420, "Wrong size on UMagicLeapARPinComponent");
static_assert(offsetof(UMagicLeapARPinComponent, ObjectUID) == 0x000268, "Member 'UMagicLeapARPinComponent::ObjectUID' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, UserIndex) == 0x000278, "Member 'UMagicLeapARPinComponent::UserIndex' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, AutoPinType) == 0x00027C, "Member 'UMagicLeapARPinComponent::AutoPinType' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, bShouldPinActor) == 0x00027D, "Member 'UMagicLeapARPinComponent::bShouldPinActor' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, PinDataClass) == 0x000280, "Member 'UMagicLeapARPinComponent::PinDataClass' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, SearchPinTypes) == 0x000288, "Member 'UMagicLeapARPinComponent::SearchPinTypes' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, SearchVolume) == 0x0002D8, "Member 'UMagicLeapARPinComponent::SearchVolume' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, OnPersistentEntityPinned) == 0x0002E0, "Member 'UMagicLeapARPinComponent::OnPersistentEntityPinned' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, OnPersistentEntityPinLost) == 0x0002F0, "Member 'UMagicLeapARPinComponent::OnPersistentEntityPinLost' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, OnPinDataLoadAttemptCompleted) == 0x000300, "Member 'UMagicLeapARPinComponent::OnPinDataLoadAttemptCompleted' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, PinnedCFUID) == 0x000310, "Member 'UMagicLeapARPinComponent::PinnedCFUID' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, PinnedSceneComponent) == 0x000320, "Member 'UMagicLeapARPinComponent::PinnedSceneComponent' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, PinData) == 0x000328, "Member 'UMagicLeapARPinComponent::PinData' has a wrong offset!");
...
{
public:
	struct FGuid                                  PinId;                                             // 0x02B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bVisibilityOverride;                               // 0x02C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AMagicLeapARPinInfoActorBase) == 0x0002D0, "Wrong size on AMagicLeapARPinInfoActorBase");
static_assert(offsetof(AMagicLeapARPinInfoActorBase, PinId) == 0x0002B8, "Member 'AMagicLeapARPinInfoActorBase::PinId' has a wrong offset!");
static_assert(offsetof(AMagicLeapARPinInfoActorBase, bVisibilityOverride) == 0x0002C8, "Member 'AMagicLeapARPinInfoActorBase::bVisibilityOverride' has a wrong offset!");
...
{
public:
	bool                                          bInfoActorsVisibilityOverride;                     // 0x02B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2B9[0x7];                                      // 0x02B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*> AllInfoActors;                                     // 0x02C0(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_310[0x8];                                      // 0x0310(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class AMagicLeapARPinInfoActorBase> ClassToSpawn;                                      // 0x0318(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AMagicLeapARPinRenderer) == 0x000320, "Wrong size on AMagicLeapARPinRenderer");
static_assert(offsetof(AMagicLeapARPinRenderer, bInfoActorsVisibilityOverride) == 0x0002B8, "Member 'AMagicLeapARPinRenderer::bInfoActorsVisibilityOverride' has a wrong offset!");
static_assert(offsetof(AMagicLeapARPinRenderer, AllInfoActors) == 0x0002C0, "Member 'AMagicLeapARPinRenderer::AllInfoActors' has a wrong offset!");
static_assert(offsetof(AMagicLeapARPinRenderer, ClassToSpawn) == 0x000318, "Member 'AMagicLeapARPinRenderer::ClassToSpawn' has a wrong offset!");
