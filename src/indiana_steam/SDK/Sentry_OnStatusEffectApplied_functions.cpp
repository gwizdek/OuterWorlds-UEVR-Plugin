...
#include "Sentry_OnStatusEffectApplied_classes.hpp"
#include "Sentry_OnStatusEffectApplied_parameters.hpp"
...
TArray<class UDecisionTreeRequestData*> USentry_OnStatusEffectApplied_C::RunDecisionTree(class AIndianaAiCharacter* Owner, class FName EventType, class UAIEventInfo* EventInfo, EDecisionTreeRequestPriority* OutPriority)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Sentry_OnStatusEffectApplied_C", "RunDecisionTree");

	Params::Sentry_OnStatusEffectApplied_C_RunDecisionTree Parms{};
