...
public:
	...
	uint8                                         Pad_64C[0x44];                                     // 0x064C(0x0044)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USequenceCameraShakeCameraStandIn) == 0x000690, "Wrong size on USequenceCameraShakeCameraStandIn");
...
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentFocalLength) == 0x000640, "Member 'USequenceCameraShakeCameraStandIn::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentAperture) == 0x000644, "Member 'USequenceCameraShakeCameraStandIn::CurrentAperture' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentFocusDistance) == 0x000648, "Member 'USequenceCameraShakeCameraStandIn::CurrentFocusDistance' has a wrong offset!");
...
public:
	...
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x02C8(0x0014)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_2DC[0x4];                                      // 0x02DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UTemplateSequencePlayer*                SequencePlayer;                                    // 0x02E0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, Net, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        TemplateSequence;                                  // 0x02E8(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ATemplateSequenceActor, PlaybackSettings) == 0x0002C8, "Member 'ATemplateSequenceActor::PlaybackSettings' has a wrong offset!");
