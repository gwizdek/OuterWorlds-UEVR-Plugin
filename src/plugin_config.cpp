...
bool OuterWorldsPluginConfig::m_cfg_option_auto_pause_daytime = false;
bool OuterWorldsPluginConfig::m_cfg_option_attach_ammo_readout = true;
bool OuterWorldsPluginConfig::m_cfg_option_attach_character_overview = true;
bool OuterWorldsPluginConfig::m_cfg_option_attach_compass = true;
bool OuterWorldsPluginConfig::m_cfg_option_attach_item_degradation = true;
